...
<form class="form" action="index.php?view=meta-chief-basis&&action=add" method="POST">

    <div class="caption">Добавление основания на занимаемой должности</div>
    ...
    <div class="field buttons">
        ...
        <input type="button" class="button" value="Назад" onclick="window.location.href = '?view=meta-chief-basis'" />
    </div>
